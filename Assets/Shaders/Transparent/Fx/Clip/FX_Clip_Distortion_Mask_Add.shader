    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float4 node_8744 = _Time + _TimeEditor;
                float4 node_802 = _Time + _TimeEditor;
                float2 node_6487 = (float2(((_Distortion_Flow_U*node_802.g)+i.uv0.r),(i.uv0.g+(node_802.g*_Distortion_Flow_V)))+node_8744.g*float2(0,0));
                ...
                clip((lerp( _Main_Tex_var.r, (_Main_Tex_var.r*Mask_Group), _Mask_Switxh )-(1.0 - lerp( _Clip_Strength, Part_U, _Part_Clip ))) - 0.5);
////// Lighting:
////// Emissive:
                float3 V_Rgb = i.vertexColor.rgb;
                float V_A = i.vertexColor.a;
                float3 emissive = (V_Rgb*(_Main_Strength*_Main_Color.rgb*pow(_Main_Tex_var.r,_Main_Power))*V_A);
