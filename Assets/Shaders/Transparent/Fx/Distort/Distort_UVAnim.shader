...
Shader "Fx/Distort/UVAnim"
{
    Properties 
    {
        ...
        _NoiseTex ("Distort Texture (RG)", 2D) = "black" {}
    ...
    CGINCLUDE
        ...
        v2f vert (appdata_t v)
        {
            ...
            o.uvdistort = TRANSFORM_TEX( v.texcoord, _NoiseTex );
        ...
        half4 frag( v2f i ) : SV_Target
        {
            ...
            //noise effect
            half offsetColor1 = tex2D(_NoiseTex, i.uvdistort + frac(time.xz * _HeatTime));
            half offsetColor2 = tex2D(_NoiseTex, i.uvdistort + frac(time.yx * _HeatTime));
